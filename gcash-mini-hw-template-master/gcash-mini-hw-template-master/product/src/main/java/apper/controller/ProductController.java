...
public class ProductController {
    ...
    private final ProductApp.GCashMiniProperties gCashMiniProperties;

    public ProductController(ProductService productService, RestTemplate restTemplate, ProductApp.GCashMiniProperties gCashMiniProperties) {
    ...
    public ResponseEntity<GenericResponse> purchaseProduct(
        ...
        ResponseEntity<UserData> UserDataResponse = restTemplate.getForEntity(gCashMiniProperties.getAccountUrl()+"/"+request.getAccountId(), UserData.class);
        ...
        if (user_balance > product_cost){
            ...
            restTemplate.postForEntity(gCashMiniProperties.getAccountUrl()+"/" + request.getAccountId(), update_user_request, GenericResponse.class);
